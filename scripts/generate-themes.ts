...
const TANGERINE_PALETTES: Record<string, TangerinePalette> = {
  ...
  '#242424': {
    light: {
      ...
      primary: '#596273',
      primaryActive: '#485365',
      primaryLines: 'rgba(89, 98, 115, 0.12)',
      primaryBg: 'rgba(89, 98, 115, 0.045)',
    ...
    dark: {
      ...
      primary: '#a8b4c4',
      primaryActive: '#bbc6d4',
      primaryLines: 'rgba(168, 180, 196, 0.2)',
      primaryBg: 'rgba(168, 180, 196, 0.12)',
